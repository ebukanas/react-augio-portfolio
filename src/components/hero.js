  ...
  return (
    ...
    data-section="bg-purple">
        ...
        <a href="workpage.html" 
           ...
           <button 
           className="test w-full h-12 bg-transparent border-[3px] border-white text-white mb-14 font-bold hover:scale-105 duration-200
            md:w-52 md:h-10 lg:w-70">MANO MENAS</button>
        </a>
